...
@Component(name = "Controller.Symmetric.BalancingOmei", immediate = true, configurationPolicy = ConfigurationPolicy.REQUIRE)
public class BalancingOmei extends AbstractOpenemsComponent implements Controller, OpenemsComponent {
	...
	private final Logger log = LoggerFactory.getLogger(BalancingOmei.class);
